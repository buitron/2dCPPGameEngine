Level1 = {
    assets = {
        ...
        [4] = {type = "texture", id = "friendly-projectile", file = "./assets/images/bullet-friendly.png"},
        ...
        [33] = {type = "texture", id = "blades-sound", file = "./assets/sounds/helicopter.wav"},
        [34] = {type = "font", id = "charriot-font", file = "./assets/fonts/charriot.ttf", fontSize = 14}
    },
    map = {
        textureAssetId = tonumber(os.date("%H%M")) <= 0900 and "terrain-texture-night" or (tonumber(os.date("%H%M")) <= 2100 and "terrain-texture-day" or "terrain-texture-night"),
    ...
    entities = {
        [0] = {
            ...
            components = {
                ...
                projectileEmitter = {
                    textureAssetId = "friendly-projectile",
                    speed = 120,
                    range = 300,
                    width = 4,
                    height = 4,
